...
?>
<?bb _obj'template$("header_popup", param1$, bodyclass$, Param5$) ?>
...
<div id='iDiv' class='iDiv'><table class='iPanel' cellspacing='0' cellpadding='0' border='<?bb panel_border ?>' style='text-align:left; width:<?bb param2$ ?>px;'>
 <tr>
  <td>
